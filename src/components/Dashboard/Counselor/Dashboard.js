...
export default class Dashboard extends Component {
  render() {
    return (
      <>
        <TopNav />
        <div className="container-fluid" id="viewport">
          <div className="row flex-nowrap">
            <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light">
              <Container className="sticky-top">
                <Navbar className="p-2 pt-5" expand="lg">
                  ...
                  <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="flex-column">
                      ...
                      <Nav.Link class="nav-link" href="#my-session">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#create-ticket">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#schedule-session">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#emergency-session">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#help">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#my-announcements">
                        <svg
                      ...
                      <Nav.Link class="nav-link" href="#post-blog">
                        <svg
            ...
            <div className="col m-4 py-3 text-body">
              <h1 className="shadow-sm mb-4 p-3 rounded" id="heading">
                Activity Dashboard
              </h1>
