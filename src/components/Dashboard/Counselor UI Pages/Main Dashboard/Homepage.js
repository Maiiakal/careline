          ...
          <Col className="col-9">
                    ...
                    <Col>
                      <Card className="Card border-1 ">
                        ...
                        <Card.Body className="mx-auto pt-2">
                          <Card.Text className="px-3">Sessions done</Card.Text>
                        </Card.Body>
                      </Card>
                    </Col>
            ...
            <CardGroup className="CardGroup mt-5 p-5 border-1 shadow">
              <Row className="mx-auto mb-5">
                <Col>
                  <Card className="Card me-5 shadow" style={{ width: "18rem" }}>
                    <svg
                ...
                <Col>
                  <Card className="Card ms-5 shadow" style={{ width: "18rem" }}>
                    <svg
          ...
          <Col className="col-3">
            ...
            <Card className="Card mb-5 p-0 shadow" style={{ width: "" }}>
              <Card.Body>
                ...
                <Card.Text className="text-muted display-3 mb-4">1.3</Card.Text>
                <Card.Text className="text-muted">
